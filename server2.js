// 1. Cargar variables de entorno (asegúrate de tener instalado dotenv: npm install dotenv)
...
// 2. Conexión a la BD utilizando variables de entorno
// Estas variables se leerán desde tu archivo .env (localmente) 
// o desde el panel de Variables de Railway (en la nube)
...
// 4. Inicio del servidor usando puerto de entorno o default 4000
const PORT = process.env.PORT || 4000;
app.listen(PORT, () => console.log(`Servidor corriendo en puerto ${PORT} 🏃‍♂️`));